...
class LoginView(TokenObtainPairView):
    ...
    Supports both username/password and PIN-based login.
    """
    ...
    def post(self, request, *args, **kwargs):
        ...
        # If PIN is provided, use PIN-based authentication
        if pin:
            return self.pin_login(request, pin, *args, **kwargs)
        
        # Otherwise, use default username/password authentication
